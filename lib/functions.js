...
export function readData( filename = path.join(docDir, 'data.json') )
{
    // 如果文件不存在，返回空对象
...
export function writeData( data, filename = path.join(docDir, 'data.json') )
{
    // 将数据转换为JSON字符串
